                ...
                if srt_files:
                    ...
                    if create_adjusted_srt_file(source_srt_path, output_srt_path, segments):
                        ...
                        if conversion_success:
                            ...
                            logger.info(f"[Job {job_id}] Using ASS filter for SRT: {subtitle_filter}")
                        else:
                            logger.error(f"[Job {job_id}] Failed to convert SRT to ASS. No subtitles will be embedded.")
                            subtitle_filter = None
                    else:
...
from .routes import chat, tasks, doc_files, monitoring
