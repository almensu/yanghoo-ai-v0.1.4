...
| Stage | Title | Status | Validation Center & Key Notes |
| :--- | :--- | :--- | :--- |
...
-   **Stage 21**: Transitioned study pack from Markdown to structured JSON import workflows. Real-world quality verified.
-   **Stage 22**: LLM-extracted queries now handle complex natural language requests like "Morning routine for a kid."
-   **Stage 23**: Native Scene Pack support implemented in English Search UI. 
-   **Stage 24**: Browser evidence shows correct grouping by query and isolation from global search input state.
